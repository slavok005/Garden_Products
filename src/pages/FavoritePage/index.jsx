...
import { getDiscountFavoriteAction, sortAllFavoriteAction, sortByPriceFavoriteAction } from "../../store/reducers/favoriteReducer";
...
export default function FavoritePage() {
  ...
  useEffect(() => {
    dispatch(sortByPriceFavoriteAction({
        min: minValue,
        max: maxValue
    }))
